...
def fieldofview(start_x, start_y, map_width, map_height, radius, func_visit_tile, func_tile_blocked):
    """
    ...
    # Northeast quadrant
    __checkQuadrant(visited, start_x, start_y, 1, 1, max_extent_x, max_extent_y, func_visit_tile, func_tile_blocked)

    # Southeast quadrant
    __checkQuadrant(visited, start_x, start_y, 1, -1, max_extent_x, min_extent_y, func_visit_tile, func_tile_blocked)

    # Southwest quadrant
    __checkQuadrant(visited, start_x, start_y, -1, -1, min_extent_x, min_extent_y, func_visit_tile, func_tile_blocked)

    # Northwest quadrant
    __checkQuadrant(visited, start_x, start_y, -1, 1, min_extent_x, max_extent_y, func_visit_tile, func_tile_blocked)
